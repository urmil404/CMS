                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 m-b30">
                            <h2 class="title-head ">Learn a new skill online<br />
                                <span class="text-primary">on your time</span></h2>
                            ...
                            <div class="row">
                                    ...
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell">
                                                <img src="public/assets/images/icon/icon1.png" alt="" /></a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell">
                                                <img src="public/assets/images/icon/icon2.png" alt="" /></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell">
                                                <img src="public/assets/images/icon/icon3.png" alt="" /></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell">
                                                <img src="public/assets/images/icon/icon4.png" alt="" /></a>
                                        </div>
                                        <div class="icon-content">
                                            <h5 class="ttr-tilte">Our Philosophy</h5>
                                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing.</p>
                ...
                <div class="container">
                    <div class="row align-items-center d-flex">
                        ...
                        <div class="col-lg-7 col-md-12 heading-bx p-lr">
                            <div class="video-bx">
                                <img src="public/assets/images/about/pic1.jpg" alt="" />
                        ...
                        <div class="item">
                            <div class="testimonial-bx">
                                <div class="testimonial-thumb">
                                    <img src="public/assets/images/testimonials/pic1.jpg" alt="">
                                </div>
