                                        ...
                                        <div class="profile-head">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <%--<asp:Button CssClass="btn btn-success float-right" Text="New Admission" ID="txt_Add_admission" runat="server" OnClick="take_admission" />--%>
                                                        <button type="button" class="btn btn-success float-right" onclick="location.href='admission.aspx';">New Admission</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
