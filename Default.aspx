                ...
                <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display: none;" data-version="5.3.0.2">
                    <ul>
                        ...
                        <li data-index="rs-100"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="public/assets/images/slider/slide1.jpg" alt=""
                        ...
                        <li data-index="rs-200"
                            ...
                            data-easeout="default"
                            data-masterspeed="default"
                            data-thumb="public/assets/images/slider/slide1.jpg"
                            data-rotate="0"
                            data-fstransition="fade"
                            data-fsmasterspeed="1500"
                            data-fsslotamount="7"
                            ...
                            data-description="Science says that Women are generally happier">
                            <!-- MAIN IMAGE -->
                            <img src="public/assets/images/slider/slide2.jpg" alt=""
                                data-bgposition="center center"
                                data-bgfit="cover"
                                data-bgrepeat="no-repeat"
                                data-bgparallax="10"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                <div class="action-box">
                                    <img src="public/assets/images/our-services/pic1.jpg" alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                <div class="action-box">
                                    <img src="public/assets/images/our-services/pic2.jpg" alt="">
                                </div>
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="service-bx m-b0">
                                <div class="action-box">
                                    <img src="public/assets/images/our-services/pic3.jpg" alt="">
                                </div>
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                    ...
                    <div class="row">
                        <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/courses/pic1.jpg" alt="">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/courses/pic2.jpg" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/courses/pic3.jpg" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/courses/pic4.jpg" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
                    ...
                    <div class="row">
                        <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
                            <div class="item">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/event/pic4.jpg" alt="">
                                    </div>
                            ...
                            <div class="item">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/event/pic3.jpg" alt="">
                                    </div>
                                    <div class="info-bx d-flex">
                                        <div>
                                            <div class="event-time">
                            ...
                            <div class="item">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img src="public/assets/images/event/pic2.jpg" alt="">
                                    </div>
                                    <div class="info-bx d-flex">
                                        <div>
                                            <div class="event-time">
                ...
                <div class="container">
                    ...
                    <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                        ...
                        <div class="item">
                            <div class="testimonial-bx">
                                <div class="testimonial-thumb">
                                    <img src="public/assets/images/testimonials/pic2.jpg" alt="">
                                </div>
                                <div class="testimonial-info">
                                    <h5 class="name">Peter Packer</h5>
                                    <p>-Art Director</p>
                    ...
                    <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                        <div class="item">
                            <div class="recent-news">
                                <div class="action-box">
                                    <img src="public/assets/images/blog/latest-blog/pic1.jpg" alt="">
                                </div>
                                <div class="info-bx">
                                    <ul class="media-post">
                        ...
                        <div class="item">
                            <div class="recent-news">
                                <div class="action-box">
                                    <img src="public/assets/images/blog/latest-blog/pic2.jpg" alt="">
                                </div>
                                <div class="info-bx">
                                    <ul class="media-post">
                        ...
                        <div class="item">
                            <div class="recent-news">
                                <div class="action-box">
                                    <img src="public/assets/images/blog/latest-blog/pic3.jpg" alt="">
                                </div>
                                <div class="info-bx">
                                    <ul class="media-post">
...
<asp:Content ID="index_footer" ContentPlaceHolderID="footer" runat="server">
</asp:Content>
