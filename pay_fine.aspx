<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pay_fine.aspx.cs" Inherits="pay_fine" %>
            ...
            <div class="account-form-inner">
                <div class="account-container">
                    <div class="heading-bx left">
                        <h2 class="title-head">Pay Fine</h2>
                    </div>
                        ...
                        <div class="row placeani">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Fees</label>
                                    <asp:TextBox CssClass="form-control" ID="title" runat="server" Enabled="false" Text=" "></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="title_rfv" runat="server" ErrorMessage="* Course is  Required" CssClass="text-valid text-danger pl-2" ControlToValidate="title" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Fees</label>
                                    <asp:TextBox CssClass="form-control" ID="amount" runat="server" Enabled="false" Text=" "></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="amount_rfv" runat="server" ErrorMessage="* Course is  Required" CssClass="text-valid text-danger pl-2" ControlToValidate="course" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 m-b30">
                                    <asp:Button runat="server" ID="client_btn_submit" CssClass="btn button-md" Text="Take Admission & Pay Fees" OnClick="paynow" />
                                </div>
                            </div>
                    </form>
                </div>
